...
def load_stats(stat_type,con,contrast,stats_root_readID,stats_root_readdata,split_half=0):
    ...
    import warnings
    subjs = [subj for subj in subjs if subj != 'D0024' and subj != 'D0107' and subj != 'D0042' and subj != 'D0115' and subj != 'D0117' and subj != 'D0100' and subj != 'D0079']# and subj != 'D0028'] # problematic patients: 102 and 103: eeg electrodes, 107, plotting issues, 42: bad heading, each should be dealed with
