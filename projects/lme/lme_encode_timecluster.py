...
is_huge='onlysemproxy'#'_huge' # if it is huge, '_huge'
for alignment,xlim_align in zip(
        ('Aud','Resp','Go'),
        ([-0.2, 1.75],[-0.2, 1.25],[-0.2, 1.25])):
    for elec_grp,elec_col,fea_plot_yscale in zip(('Motor','Sensorymotor','Auditory','Delay_only','Wgw_p55b','Wgw_a55b'),
                                                         (Motor_col,Sensorimotor_col,Auditory_col,Delay_col,WGW_p55b_col,WGW_a55b_col),
                                                         (2,3.5,3.5,4,3.5,3.5)):

        fea = 'ACC'
        fea_tag = 'ACC'
        para_sig_barbar = [0.07, 0.007]
