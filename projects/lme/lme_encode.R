  ...
  for (delay_nodelay in delay_nodelays){
    for (alignment in alignments){
      for (elec_grp in elec_grps){
        ...
        write.csv(perm_compare_df,paste(home_dir,"results/",delay_nodelay,"_",elec_grp,"_",alignment,"_",lex,rep_yn,"_huge_testλ_",lambda_test,".csv",sep = ''),row.names = FALSE)
