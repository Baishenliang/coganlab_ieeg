...
for rep_or_yn,output_suffix in zip(('inRep','inYN'),('','_yn')):
    if groupsTag=="LexDelay":
        ...
        data_LexDelayRep_Delay, _ = gp.load_stats('mask', 'Delay_inRep', contrast, stats_root_delay, stats_root_delay)
        epoc_LexDelayRep_Delay, _ = gp.load_stats(epoc_bsl_type, f'Delay_{rep_or_yn}', 'epo', stats_root_delay, stats_root_delay,
    ...
    if groupsTag=="LexDelay":
        ...
        #elec_grps=('Motor_vWM','Auditory_vWM','Sensorymotor_vWM','Delay_only')#,
        elec_grps=('Motor_novWM','Auditory_novWM','Sensorymotor_novWM')#,'Wgw_p55b','Wgw_a55b')#,'Delay_only')
        ...
        elec_idxs=('LexDelay_Motor_not_in_Delay_sig_idx','LexDelay_Auditory_not_in_Delay_sig_idx','LexDelay_Sensorimotor_not_in_Delay_sig_idx')#,'Wgw_p55b','Wgw_a55b')
                #'Hikock_Spt','Hikock_lPMC','Hikock_lIPL','Hikock_lIFG')
        for epoc,epoc_tag in zip((epoc_LexDelayRep_Aud,epoc_LexDelayRep_Delay,epoc_LexDelayRep_Go,epoc_LexDelayRep_Resp),
                                ('epoc_LexDelayRep_Aud','epoc_LexDelayRep_Delay','epoc_LexDelayRep_Go','epoc_LexDelayRep_Resp')):
