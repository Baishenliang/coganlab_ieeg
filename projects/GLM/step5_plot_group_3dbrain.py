...
#%% Plot brain
subjs, _, _, chs, times = glm.fifread("Auditory", 'zscore', 'Repeat')
...
for TypeLabel, chs_ov, base_sig, spec_sig in zip(
        ...
        (gp.set2arr(sig_idx["Auditory/Repeat/Acoustic/aud"] | sig_idx["Auditory/Repeat/Phonemic/aud"] | sig_idx["Auditory/Repeat/Lexical/aud"],len(chs_all)),
        gp.set2arr(sig_idx["Auditory/Repeat/Acoustic/del"] | sig_idx["Auditory/Repeat/Phonemic/del"] | sig_idx["Auditory/Repeat/Lexical/del"],len(chs_all)),
        gp.set2arr(sig_idx["Resp/Repeat/Acoustic/resp"] | sig_idx["Resp/Repeat/Phonemic/resp"] | sig_idx["Resp/Repeat/Lexical/resp"],len(chs_all))),
